...
export function initPoolEpsilon(poolAddress) {
  const abi = [
    ...
    'function createJoinProposal(address _user, string _title, string _description, uint256 _amount, uint256 _govTokens)',
    ...
    'function govTokenPrice() view returns (uint256 price)',
    'function govTokensOf(address _user) view returns (uint256 balance)',
    ...
    'function totalGovTokens() view returns (uint256 balance)',
