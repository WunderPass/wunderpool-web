  ...
  return (
    <div className="container-white pb-16 ">
      <div className="flex flex-col items-center justify-center text-center mt-2 mb-5">
        <div className="opacity-50 text-base h-auto sm:h-14 ">{event.name}</div>
        <div className="flex h-auto sm:h-16 flex-row items-center justify-between w-full sm:text-2xl text-lg ">
