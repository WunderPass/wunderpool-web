import { FormattedParticipant } from '../../../../services/bettingHelpers';
import { showWunderIdsAsIcons } from '../../../../services/memberHelpers';

function sortMembersOnVotes(participants: FormattedParticipant[]) {
  let votes = null;
...
export default function EventCardVotePreview({
  participants,
}: {
