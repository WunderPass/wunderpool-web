...
import CurrencyInput from '../../general/utils/currencyInput';
import { currency } from '../../../services/formatter';
import ResponsiveDialog from '../../general/utils/responsiveDialog';
import EventInput from '../../betting/events/input';
...
export default function BettingGameDialog(props: BettingGameDialogProps) {
  const { open, wunderPool, handleOpenClose } = props;
