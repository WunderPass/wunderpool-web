...
type DashboardShareCompetitionCardProps = {
...
export default function ShareCompetitionCard({
  ...
  handleError,
  user,
}: DashboardShareCompetitionCardProps) {
  ...
  const captureScreenshot = async () => {
    const dataUrl = await toPng(
      document.getElementById(`share-competition-${competition.competitionId}`),
      {
  ...
  return (
    <div
      id={`share-competition-${competition.competitionId}`}
