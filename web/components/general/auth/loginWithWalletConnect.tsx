...
type LoginWithWalletConnectProps = { onSuccess: AuthCallback };

export default function LoginWithWalletConnect({
  onSuccess,
}: LoginWithWalletConnectProps) {
  ...
  const loginWithWalletConnect = async () => {
    ...
    (window as any).walletConnect = provider;
    try {
