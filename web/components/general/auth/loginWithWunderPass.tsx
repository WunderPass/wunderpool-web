...
export default function LoginWithWunderPass(props: LoginWithWunderPassProps) {
  const { name, image, intent = [], onSuccess, disablePopup } = props;
