    ...
    <div togglable="false">
      ...
      >
        <svg
          ...
          viewBox="0 0 512 512"
          togglable="false"
          class="ml-2 text-xl mb-1 text-casama-blue"
          height="1em"
          width="1em"
      ...
      >
        <div togglable="false">
          ...
          >
            <div togglable="false" className="flex flex-col m-2 mx-3 ">
              <span
                togglable="false"
                className="flex flex-row justify-between w-full text-base font-bold underline sm:text-center mb-1"
              >
                Scoring system:
                <span togglable="false" className="flex flex-row justify-end">
                  X
                </span>
              </span>

              <div togglable="false" className="flex flex-col mx-0 sm:mx-2">
                <span togglable="false">
            ...
            <Divider togglable="false" flexItem />
            <div togglable="false" className="flex sm:flex-row flex-col">
              <div togglable="false" className="m-2 mx-3">
                <div togglable="false" className="flex flex-col w-64">
                  <span
                    togglable="false"
                    className="text-base font-bold underline sm:text-center mb-1"
                  >
                    Winner Takes It All:
                  </span>
                  <span togglable="false">
              ...
              />
              <Divider togglable="false" className="sm:hidden flex" flexItem />
              <div togglable="false" className="m-2 mx-3">
                <div togglable="false" className="flex flex-col w-64">
                  <span
                    togglable="false"
