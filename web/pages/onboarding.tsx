...
import { SelectedCompetitionParams } from '../components/betting/events/eventCard';
...
const eventCompetitions: FormattedCompetition[] = [
  {
    competitionId: 1669212668391,
    name: 'Soccer Competition - Germany vs. Spain',
    version: 'BETA',
...
export default function Onboarding(props: OnboardingProps) {
  const [guessOne, setGuessOne] = useState<string | number>('');
  const [guessTwo, setGuessTwo] = useState<string | number>('');
